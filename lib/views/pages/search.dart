...
class SearchPage extends StatefulWidget {
  ...
  SearchPage({required this.searchQuery, Key? key}) : super(key: key);
...
class _SearchPageState extends State<SearchPage> with TickerProviderStateMixin {
  ...
  SearchApiServices searchApiServices = SearchApiServices();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: buildAppBar("Search Page", context),
      body: Padding(
          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<SearchModel>(
                future:
                    searchApiServices.getSearchWallpaperApi(widget.searchQuery),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    image: NetworkImage(
                                      searchPhotos?.src?.original.toString() ??
                                          "",
                                    ),
                                    fit: BoxFit.cover,
                                  ),
